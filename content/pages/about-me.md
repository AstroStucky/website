...
I have been intimately involved with the local Salt Lake Valley game development scene. Organized through the SLC Game Devs Discord server, I have delivered 3 in-person presentations on game development topics and 1 live demonstration about building a 3D game in Godot.

* Talk on procedural generation in games titled *Building Procedural Worlds*.
  * [Presentation Slides](https://docs.google.com/presentation/d/1Itx4PHA_7pdI-ffwtI94CBXSD8xiE8Y7bhvLkZYdlOQ/edit?usp=sharing)
* Talk on building an easy 2D fluid simulation in Godot titled *Fast and Easy 2D Fluid Simulation*.
...
* Talk on finite state machines titled *Finite State Machines: A Game Developer's Best Friend*. (_online version of presentation still to come_)
